namespace FixTrading.Application.Interfaces.Fix
{
    ...
    public interface IFixSession
    {
        ...
        void Subscribe(string symbol);  //Verilen sembol için Market Data isteği gönderir. Sembol zaten aktifse tekrar göndermez (idempotent).
        void Unsubscribe(string symbol);  //Verilen sembol için Market Data aboneliğini iptal eder.
        bool IsSubscribed(string symbol); //Verilen sembol için aktif bir Market Data aboneliği olup olmadığını döner.
    }
}
